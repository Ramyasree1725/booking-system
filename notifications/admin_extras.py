"""Admin helpers and mixins for notifications."""
...
class NotificationsAdminMixin:
    ...
    @admin.action(description="Bulk action 0 for notifications")
    ...
    @admin.action(description="Bulk action 1 for notifications")
    ...
    @admin.action(description="Bulk action 2 for notifications")
    ...
    @admin.action(description="Bulk action 3 for notifications")
    ...
    @admin.action(description="Bulk action 4 for notifications")
    ...
    @admin.action(description="Bulk action 5 for notifications")
    ...
    @admin.action(description="Bulk action 6 for notifications")
    ...
    @admin.action(description="Bulk action 7 for notifications")
    ...
    @admin.action(description="Bulk action 8 for notifications")
    ...
    @admin.action(description="Bulk action 9 for notifications")
    ...
    @admin.action(description="Bulk action 10 for notifications")
    ...
    @admin.action(description="Bulk action 11 for notifications")
