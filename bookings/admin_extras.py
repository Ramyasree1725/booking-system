"""Admin helpers and mixins for bookings."""
...
class BookingsAdminMixin:
    ...
    @admin.action(description="Bulk action 0 for bookings")
    ...
    @admin.action(description="Bulk action 1 for bookings")
    ...
    @admin.action(description="Bulk action 2 for bookings")
    ...
    @admin.action(description="Bulk action 3 for bookings")
    ...
    @admin.action(description="Bulk action 4 for bookings")
    ...
    @admin.action(description="Bulk action 5 for bookings")
    ...
    @admin.action(description="Bulk action 6 for bookings")
    ...
    @admin.action(description="Bulk action 7 for bookings")
    ...
    @admin.action(description="Bulk action 8 for bookings")
    ...
    @admin.action(description="Bulk action 9 for bookings")
    ...
    @admin.action(description="Bulk action 10 for bookings")
    ...
    @admin.action(description="Bulk action 11 for bookings")
