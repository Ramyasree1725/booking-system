"""Admin helpers and mixins for resources."""
...
class ResourcesAdminMixin:
    ...
    @admin.action(description="Bulk action 0 for resources")
    ...
    @admin.action(description="Bulk action 1 for resources")
    ...
    @admin.action(description="Bulk action 2 for resources")
    ...
    @admin.action(description="Bulk action 3 for resources")
    ...
    @admin.action(description="Bulk action 4 for resources")
    ...
    @admin.action(description="Bulk action 5 for resources")
    ...
    @admin.action(description="Bulk action 6 for resources")
    ...
    @admin.action(description="Bulk action 7 for resources")
    ...
    @admin.action(description="Bulk action 8 for resources")
    ...
    @admin.action(description="Bulk action 9 for resources")
    ...
    @admin.action(description="Bulk action 10 for resources")
    ...
    @admin.action(description="Bulk action 11 for resources")
