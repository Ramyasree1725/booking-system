"""Admin helpers and mixins for audit."""
...
class AuditAdminMixin:
    ...
    @admin.action(description="Bulk action 0 for audit")
    ...
    @admin.action(description="Bulk action 1 for audit")
    ...
    @admin.action(description="Bulk action 2 for audit")
    ...
    @admin.action(description="Bulk action 3 for audit")
    ...
    @admin.action(description="Bulk action 4 for audit")
    ...
    @admin.action(description="Bulk action 5 for audit")
    ...
    @admin.action(description="Bulk action 6 for audit")
    ...
    @admin.action(description="Bulk action 7 for audit")
    ...
    @admin.action(description="Bulk action 8 for audit")
    ...
    @admin.action(description="Bulk action 9 for audit")
    ...
    @admin.action(description="Bulk action 10 for audit")
    ...
    @admin.action(description="Bulk action 11 for audit")
