"""Admin helpers and mixins for accounts."""
...
class AccountsAdminMixin:
    ...
    @admin.action(description="Bulk action 0 for accounts")
    ...
    @admin.action(description="Bulk action 1 for accounts")
    ...
    @admin.action(description="Bulk action 2 for accounts")
    ...
    @admin.action(description="Bulk action 3 for accounts")
    ...
    @admin.action(description="Bulk action 4 for accounts")
    ...
    @admin.action(description="Bulk action 5 for accounts")
    ...
    @admin.action(description="Bulk action 6 for accounts")
    ...
    @admin.action(description="Bulk action 7 for accounts")
    ...
    @admin.action(description="Bulk action 8 for accounts")
    ...
    @admin.action(description="Bulk action 9 for accounts")
    ...
    @admin.action(description="Bulk action 10 for accounts")
    ...
    @admin.action(description="Bulk action 11 for accounts")
